...
var config = function(env) {
    var p_path = '/static/little-world-cookie-banner/dist/';
    console.log(env.LOCAL_DEBUG);

    if(env.LOCAL_DEBUG != "1"){
        p_path = 'https://fra1.digitaloceanspaces.com/lw-object-storage-bucket/static/little-world-cookie-banner/dist/'; //TODO: handle differently
    }
    console.log(p_path)
    return {
    context: __dirname,
    ...
    output: {
        path: path.join(__dirname, './assets/little-world-cookie-banner/dist'),
